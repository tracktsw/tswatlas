  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        isAndroid && "android-onboarding-content pb-4"
      )}>
        <motion.div
      ...
      {/* Footer (standardized) */}
      <div className={cn("px-6 space-y-3 shrink-0", isAndroid && "android-onboarding-fixed")} style={{ paddingBottom: 'calc(var(--safe-bottom, 0px) + 16px)' }}>
