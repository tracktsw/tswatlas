...
const InsightsPage = () => {
  ...
  return (
    <div className="px-4 py-6 space-y-6 max-w-lg mx-auto">
      ...
      {/* Photo Timeline */}
      {photosByBodyPart.length > 0 && (
        <div className="space-y-3">
          <h3 className="font-display font-semibold text-foreground">
            Photo Progress by Area
          </h3>
          <div className="glass-card p-4">
            <div className="grid grid-cols-2 gap-3">
              {photosByBodyPart.map(([part, count]) => {
                const info = bodyParts.find(b => b.value === part);
                return (
                  <div key={part} className="flex items-center gap-2 p-2 bg-muted/50 rounded-lg">
